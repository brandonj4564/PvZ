...
public class PlantsManager {
	...
	/**
	 * Get string representation of the sunflower at position
	 * <code>(col, row)</code>
	 * 
	...
	/**
	 * Get string representation of the peashooter at position
	 * <code>(col, row)</code>
	 * 
	...
	private boolean canAdd(String plantName, int row, int col) {
		...
		boolean checkResult = canPayPlant(plantName) && checkForEmptyTileAt(row, col)
				&& game.isTileEmptyFromZombie(row, col);
	...
	/**
	 * Check if there is a plant which causes attack on a zombie at position
	 * <code>(row, col)</code>
	 * 
	 * @param row row position of the zombie
	 * @param col column position of the zombie
	 * 
	 * @return <code>true</code> if there is a plant which causes attack on a zombie
	 *         at position <code>(row, col)</code>
	 */
