...
public class ZombiesManager {
	...
	// This one seems to be redundant as it has the same purpose as isZombieAt()
	// The reason we switch from isPositionEmpty() to isZombieAt() is because it is more natural to say row first and column second
